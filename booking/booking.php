...
<form action="futsaldatabse.php" method="post" id="bookingForm" onsubmit="return validateForm()">
        <div class="elem-group">
            ...
            <input type="text" id="name" name="visitor_name" placeholder="Please enter your name" pattern="[A-Za-z\s]{3,20}">
            <span class="error-message" id="name-error"></span>
        </div>

        <div class="elem-group">
            <label for="email">E-mail</label>
            <input type="email" id="email" name="visitor_email" placeholder="Please enter your email">
            <span class="error-message" id="email-error"></span>
        </div>

        <div class="elem-group">
            <label for="phone">Phone</label>
            <input type="tel" id="phone" name="visitor_phone" placeholder="Please enter your phone number" pattern="(\d{3})-?\s?(\d{3})-?\s?(\d{4})">
